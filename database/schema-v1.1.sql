-- ============================================================================
-- RECON SENTINEL — PostgreSQL Database Schema v1.1
...
CREATE TYPE scan_phase AS ENUM ('passive', 'gate_1', 'active', 'gate_2', 'vuln', 'report', 'done');
...
CREATE TYPE finding_type_enum AS ENUM (
    ...
    'js_secret', 'api_endpoint', 'dns', 'screenshot', 'osint', 'waf', 'other'
);
...
-- 
-- Tables:           28 (+1 audit_log, +1 mitre_finding_counts, -0)
-- Indexes:          52
-- Materialized Views: 1 (mv_scan_summary; heatmap replaced by trigger table)
...
-- Enum Types:       18 (+1 finding_type_enum)
-- Seed Data:        30 MITRE techniques (with multi-tactic arrays)
--
-- Fixes applied:    12/12
-- Improvements:     4/4 (pg_trgm, RLS prep, retention, finding_type enum)
-- ═══════════════════════════════════════════════════════════════════════════
